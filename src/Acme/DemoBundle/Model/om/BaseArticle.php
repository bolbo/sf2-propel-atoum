...
abstract class BaseArticle extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\DemoBundle\\Model\\ArticlePeer';
    ...
    public function setCategorieId($v)
    {
        ...
        if ($this->categorie_id !== $v) {
            $this->categorie_id = $v;
            $this->modifiedColumns[] = ArticlePeer::CATEGORIE_ID;
        }
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[] = ArticlePeer::CODE;
        }
    ...
    public function setIntitule($v)
    {
        ...
        if ($this->intitule !== $v) {
            $this->intitule = $v;
            $this->modifiedColumns[] = ArticlePeer::INTITULE;
        }
    ...
    public function setActif($v)
    {
        ...
        if ($this->actif !== $v) {
            $this->actif = $v;
            $this->modifiedColumns[] = ArticlePeer::ACTIF;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->categorie_id = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            ...
            return $startcol + 9; // 9 = ArticlePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            } elseif ($this->isColumnModified(ArticlePeer::INTITULE)) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArticlePeer::CATEGORIE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"categorie_id"';
        }
        if ($this->isColumnModified(ArticlePeer::CODE)) {
            $modifiedColumns[':p' . $index++]  = '"code"';
        }
        if ($this->isColumnModified(ArticlePeer::INTITULE)) {
            $modifiedColumns[':p' . $index++]  = '"intitule"';
        }
        if ($this->isColumnModified(ArticlePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '"description"';
        }
        if ($this->isColumnModified(ArticlePeer::ACTIF)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"description"':
                        ...
                        break;
                    case '"actif"':
                        $stmt->bindValue($identifier, $this->actif, PDO::PARAM_BOOL);
                        break;
                    case '"slug"':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setCategorieId($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticlePeer::CATEGORIE_ID)) $criteria->add(ArticlePeer::CATEGORIE_ID, $this->categorie_id);
        if ($this->isColumnModified(ArticlePeer::CODE)) $criteria->add(ArticlePeer::CODE, $this->code);
        if ($this->isColumnModified(ArticlePeer::INTITULE)) $criteria->add(ArticlePeer::INTITULE, $this->intitule);
        if ($this->isColumnModified(ArticlePeer::DESCRIPTION)) $criteria->add(ArticlePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(ArticlePeer::ACTIF)) $criteria->add(ArticlePeer::ACTIF, $this->actif);
    ...
    {
        return '' . $this->cleanupSlugPart($this->getIntitule()) . '';
    }
    ...
    protected function makeSlugUnique($slug, $separator = '-', $alreadyExists = false)
    {
        ...
        ->where('q.Slug ' . ($alreadyExists ? '~*' : '=') . ' ?', $alreadyExists ? '^' . $slug2 . '[0-9]+$' : $slug2)->prune($this)
        ;
